...
export const createElement = <K extends keyof HTMLElementTagNameMap>(
    tagName: K,
): ElementBuilder<K> => new ElementBuilder(tagName);
...
export class ElementBuilder<K extends keyof HTMLElementTagNameMap> {
     ...
     *
     * ```typescript
     * const firstChild = createElement("span").text("First child");
     * const secondChild = createElement("span").text("Second child");
     *
     ...
     *     createElement("span").text("First child"),
     *     createElement("span").text("Second child"),
     * );
     * ```
     *
     * @param children - One or more child elements to be appended. Each child
     ...
     *
     * createElement("div").text("Child element").appendTo(parent);
     * ```
     *
     ...
     */
    appendTo(
        parent: ElementBuilder<keyof HTMLElementTagNameMap> | HTMLElement,
    ): this {
        const parentElement =
     ...
     *
     * ```typescript
     * createElement("input").attr({ type: "text", disabled: true });
     * ```
     *
     * @param attributes - An object where keys are attribute names and values
     *   are attribute values. Boolean `true` sets the attribute to an empty
     *   string (for boolean attributes), `false` removes it.
     * @returns The current instance of `ElementBuilder` for method chaining.
     */
    attr(attributes: Record<string, boolean | string>): this {
     ...
     *
     * ```typescript
     * createElement("div").class("class1", "class2");
     * ```
     *
     ...
     * ```typescript
     * createElement("div")
     *     .if(condition1, (div) => div.style({ color: "red" }))
     *     .elseIf(condition2, (div) => div.style({ color: "green" }))
     ...
     *
     * ```typescript
     * createElement("div").text("This is a hidden div").hide();
     * ```
     *
     * @returns The current instance of `ElementBuilder` for method chaining.
     */
    ...
    /**
     * Sets the inner HTML of the element. This method tries to use the new
     * `setHTML` API which prevents XSS vulnerabilities by sanitizing the HTML
     * string from unsafe elements. It can however fall back to `innerHTML` if
     * `setHTML` is not supported in the current environment and thus you should
     * ensure that the HTML string is safe to use and won't cause XSS
     * vulnerabilities.
     *
     * @example
     *
     * ```typescript
     * createElement("div").html("<strong>Bold text</strong>");
     * ```
     *
     ...
     *
     * createElement("div")
     *     .text("An element after the reference")
     ...
     */
    insertAfter(
        reference: ElementBuilder<keyof HTMLElementTagNameMap> | HTMLElement,
    ): this {
        const referenceElement =
            reference instanceof ElementBuilder ? reference.node() : reference;
        referenceElement.after(this._element);
        return this;
    }
     ...
     *
     * createElement("div")
     *     .text("An element before the reference")
    ...
    insertBefore(
        ...
        const referenceElement =
            reference instanceof ElementBuilder ? reference.node() : reference;
        referenceElement.before(this._element);
        return this;
    }
     ...
     *
     * ```typescript
     * const divElement = createElement("div").text("This is a div").node();
     * ```
     *
     ...
     * @param options - Optional options for the event listener (e.g., provided
     *   `signal` from an AbortController to be able to remove the listener from
     *   `cleanup()` function).
     * @returns The current instance of `ElementBuilder` for method chaining.
     */
     ...
     *
     * ```typescript
     * createElement("div").text("This div will be removed").remove();
     * ```
     *
     * @returns The current instance of `ElementBuilder` for method chaining.
     */
     ...
     *
     * ```typescript
     * createElement("a").rmAttr("href", "target");
     * ```
     *
     * @param attributeNames - One or more attribute names to be removed from
     *   the element.
     * @returns The current instance of `ElementBuilder` for method chaining.
     */
    rmAttr(...attributeNames: string[]): this {
     ...
     *
     * ```typescript
     * createElement("div").rmClass("class1", "class2");
     * ```
     *
     * @param classNames - One or more class names to be removed from the
     *   element.
     * @returns The current instance of `ElementBuilder` for method chaining.
     */
     ...
     *
     * ```typescript
     * createElement("div").rmData("userId", "sessionId", "token");
     * ```
     *
     ...
     *
     * ```typescript
     * createElement("div").text("This is a div").show();
     * ```
     *
     * @returns The current instance of `ElementBuilder` for method chaining.
     */
     ...
     * ```
     *
     * @param styles - An object where keys are CSS property names (in
     *   camelCase) and values are the corresponding CSS values to be set on the
     *   element.
     * @returns The current instance of `ElementBuilder` for method chaining.
     */
    style(styles: Partial<Record<keyof CSSStyleDeclaration, string>>): this {
     ...
     *
     * ```typescript
     * createElement("span").text("Hello world");
     * ```
     *
     ...
     *
     * ```typescript
     * createElement("div").tgClass("active");
     * ```
     *
     * @param className - The class name to be toggled on the element.
     * @returns The current instance of `ElementBuilder` for method chaining.
     */
    tgClass(className: string): this {
     ...
     *
     * ```typescript
     * const div = createElement("div").text("This is a div").toggle();
     * ```
     *
     * @returns The current instance of `ElementBuilder` for method chaining.
     */
